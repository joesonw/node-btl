...
_tagEngine.prototype.addTag = function add(name,fn) {
	Assert(fn,
...
_tagEngine.prototype.resolveTag = function *resolve(ele,push,context) {
	var fn;
...
_tagEngine.prototype.hasTag = function has(ele) {
...
_tagEngine.prototype.resolveController = function *run(name,ele,push,context) {
